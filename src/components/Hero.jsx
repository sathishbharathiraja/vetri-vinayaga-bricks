...
const Hero = () => {
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center pt-24 pb-12 overflow-hidden bg-brand-bg w-full">
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16 w-full relative z-10">
